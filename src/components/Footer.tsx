const Footer = () => (
  <footer className="py-16 bg-background border-t border-border">
    <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
      <p className="font-serif text-lg tracking-[0.3em] text-primary mb-1">ÉCLIPSE</p>
      <p className="text-[0.45rem] tracking-[0.3em] uppercase text-foreground/85 mb-4" style={{ fontFamily: "'Cinzel', serif" }}>COPENHAGEN</p>
